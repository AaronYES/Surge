...
if (typeof $response === "undefined") {
  ...
  if (url.includes("/v1/activity")) {
    ...
    // 我的页面
    if (obj.vip) {
      obj.vip.expires_time = "3392838427";
    }
    if (obj.svip) {
      obj.svip.expires_time = "3392838427";
    }
    ...
    if (obj.result) {
      ...
      obj.result.vip_expired_at = 3392838427.16;
      obj.result.is_vip = true;
      obj.result.xy_svip_expire = 3392838427.16;
      if (obj.result.wt) {
        if (obj.result.wt.vip) {
          obj.result.wt.vip.enabled = true;
          obj.result.wt.vip.expired_at = 3392838427.16;
          obj.result.wt.vip.svip_expired_at = 3392838427.16;
        }
        obj.result.wt.svip_given = 730;
      }
      obj.result.is_primary = true;
      obj.result.xy_vip_expire = 3392838427.16;
      obj.result.svip_expired_at = 3392838427.16;
